...
def get_cune(
    ...
    # CodImp2 + ValImp2 + CodImp3 + ValImp3 + ValTot + NitOFE + NumAdq +
    # Software-PIN + TipoAmbie)
    uncoded_value = (str(NumNE) + ' + ' + str(FecNE) + ' + ' + str(HorNE) + ' + ' +
                     str(ValDev) + ' + ' + str(ValDed) + ' + ' + str(ValTolNE) + ' + ' +
                     str(NitNE) + ' + ' + str(DocEmp) + ' + ' + str(TipoXML) + ' + ' +
                     str(SoftwarePIN) +
                     ' + ' + str(TipoAmbie))
    unicode = unidecode(str(NumNE) + str(FecNE) + str(HorNE) + str(ValDev) + str(ValDed) + str(ValTolNE) + str(NitNE) +
        str(DocEmp) + str(TipoXML) + str(SoftwarePIN) + str(TipoAmbie)).encode()
